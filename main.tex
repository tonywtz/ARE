...
I hope all is well. I read your new paper on ` The Economics of Currency Risk’. It seems very nice.

I must admit at being surprised that you didn’t include any references to my work on the carry trade. The main paper appeared in the Review of Financial Studies in 2011 well before a lot of the papers that do cite (obviously excluding Fama).

Craig Burnside, Martin Eichenbaum and Sergio Rebelo, ` The Returns to Currency Speculation in Emerging Markets’, American Economic Review, Papers and Proceedings, 97(2), 2007, 333-8

Craig Burnside, Martin Eichenbaum and Sergio Rebelo, ` The Carry Trade: The Gains from Diversification’’, Journal of the European Economics Association, 6 (2-3), 2008, 581-8.

Craig Burnside, Isaac Kleshchelski, Martin Eichenbaum and Sergio Rebelo, "Do Peso Problems Explain the Returns to the Carry Trade?”, the Review of Financial Studies 24(3), 2011, 853-91. 

Hi Tarek

Great survey. I thought I might suggest 1 amendmanet:

You say "Resilient countries therefore have lower interest rates, though how researchers should distinguish resilient from non-resilient countries in practice remains unclear."

But it is clear, as we discuss in Farhi Gabaix: you look a put premia on their currency ("risk reversals"). Low resilience countries have high put premia. 

It works pretty well: see Farhi, Fraiberger et al., and Carr-Wu cited there.

We say that in that FG QJE paper and in Farhi, Fraiberger et al. WP
...
in the abstract you mention, “earlier research focused mainly on the role of currency risk in generating violations of uncovered interest parity.”

 

Can you direct me to those papers that focus on violations of interest rate parity? That would be very helpful!


We need to cite Kremens and Martin
...
It is a great paper. It is very well structured and the substance is rich and informative.

It can be basically published as is. I just have a few comments which should be very short and easy to address.

 

    “For example, Hassan (2013) shows allowing for some economies to be larger than others within a conventional international real business cycle model is sufficient to generate long-term differences in interest rates between countries, because shocks that affect consumption in larger countries spill over more to the rest of the world.” 

 

This is hard to understand for people who have not read the paper. A bit more explanation would be great.

 

    P6: I would replace the title of the box (currently definitions) by Three facts as this is the way it is referred to later in the text.

 

    Maggiori (2015) suggest that, in practice, financiers are holding assets of net-debtor countries. As a result, investing in net-debtor countries' currencies should obtain positive excess returns. Della Corte et al. (2016) provide systematic evidence for this hypothesis in the data, and furthermore show the currencies of net-debtor countries systematically depreciate in times of financial turmoil.

 

 

This seems to be at odds with evidence on US (net debtor) and the dollar—historically tends to appreciate in bad times. This is not a small issue as the dollar is often on the balance sheet of intermediaries. So this problem should be mentioned in the text.

 

It is an excellent paper for the Annual Review. It provides an interesting synthetic and  very pedagogical view of the literature and opens interesting research questions. 