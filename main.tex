...
% This result is easiest to see when we think about spillovers: Shocks that hit large or trade-central countries spill over to the rest of the world, and are therefore are harder and more expensive to insure against. Thus, a financial asset that does provide insurance against shocks to large or trade-central countries (i.e. a risk-free bond) should be more expensive. 
%have low interest rates is because shocks that hit these important countries 
%One common prediction that is shared between all approaches in which financial markets are somewhat close to complete is that countries with low interest rates should also also be net-importers of insurance from the rest of the world. 
%After all, saying that risk-fee interest rates are lower in the United States than in New Zealand is the same as saying that US risk-free bonds are more expensive than those in New Zealand.
...
An active literature in international finance studies the propensity of firms and governments to borrow in foreign currency \citep{cespedes2004balance, du2020sovereign}. 

Original sin: WHAT ELSE EXISTS?
\begin{itemize}
    \item \citet{cespedes2004balance}
    \item \citet{Bocola2019}: Savers demanding FC deposits to insure against depreciation risk
    \item Ottenello and Perez - AEJ Macro
\end{itemize}

Deviations from UIP affect currency composition of debt:
\begin{itemize}
    \item \citet{KalemliOzcanetal2019}
    \item \citet{Richers2020}
    \item \citet{liao2020}
    \item \citet{SalomaoVarela2020}
    \item \citet{DuSchreger2016}
    \item \citet{du2020sovereign} - Firms loading up on foreign currency debt to borrow at lower interest rates increases sovereign default risk.
\end{itemize}
...
%% As we have discussed, \citet{ColacitoCroceHoHoward2018} make progress in this direction, but. 
