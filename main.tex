...
enough to eliminate the interest differential. 
...
To formally attribute the returns of currency traders to risk, we 
borrow some technology from the broader asset pricing literature.
The classic empirical asset pricing literature constructs
...
based on some characteristic of interest, and then divide assets into
...
regression coefficients (``loadings'') on the risk factor also obtain higher expected
...
techniques to exchange rates and provided systematic
